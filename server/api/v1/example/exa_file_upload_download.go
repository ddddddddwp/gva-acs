...
import (
	...
	"github.com/ddddddddwp/gva-acs/server/model/example"
	"github.com/ddddddddwp/gva-acs/server/model/example/request"
	exampleRes "github.com/ddddddddwp/gva-acs/server/model/example/response"
