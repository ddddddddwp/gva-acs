	...
	tests := []struct {
	...
	}{
		{
			...
			fields: fields{
				...
				ImportPath:        `"github.com/ddddddddwp/gva-acs/server/api/v1/example"`,
		...
		},
		{
			...
			fields: fields{
				...
				ImportPath:        `"github.com/ddddddddwp/gva-acs/server/router/example"`,
				StructName:        "Example",
				PackageName:       "example",
		...
		},
		{
			...
			fields: fields{
				...
				ImportPath:        `"github.com/ddddddddwp/gva-acs/server/service/example"`,
